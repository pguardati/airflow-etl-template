...
import json
import configparser
from airflow_etl_template.constants import logging
...
class CloudInfrastructureConstructor:
    """Destroy the infrastructure that host the database"""
    def __init__(self, config_file):
        """Get configuration of the machine described in the configuration file
        Args:
    ...
    def enable_communication_s3_with_dwh(self, dwh_vpc_id):
        ...
        try:
            ...
            print(e) # avoid stopping execution if user already has the permissions
