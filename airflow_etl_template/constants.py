...
# General
PROJECT_NAME = 'airflow_etl_template'
...
DIR_DATA_TEST = os.path.join(PROJECT_PATH, 'redshift/tests', 'test_data')
VIZ_TEST = True

# DWH Config
CONFIG_PATH_DWH_LAUNCH = os.path.join(REPOSITORY_PATH, "config", "dwh_launch.cfg")
CONFIG_PATH_DWH_CURRENT = os.path.join(REPOSITORY_PATH, "config", "dwh.cfg")
