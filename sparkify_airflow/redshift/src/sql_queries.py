...
# TABLE CONSTRAINTS
dq_checks = [
    {'check_sql': """SELECT sum(case when songplay_id is null then 1 else 0 end) FROM songplays""",
     'expected_result': 0},
    {'check_sql': """SELECT sum(case when user_id is null then 1 else 0 end) FROM users""",
     'expected_result': 0},
    {'check_sql': """SELECT sum(case when start_time is null then 1 else 0 end) FROM time""",
     'expected_result': 0},
    {'check_sql': """SELECT sum(case when song_id is null then 1 else 0 end) FROM songs""",
     'expected_result': 0},
    {'check_sql': """SELECT sum(case when artist_id is null then 1 else 0 end) FROM artists""",
     'expected_result': 0},
]
